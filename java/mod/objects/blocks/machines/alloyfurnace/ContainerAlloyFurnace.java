...
import isaac.mod.objects.blocks.machines.alloyfurnace.slots.SlotAlloyFurnaceFuel;
import isaac.mod.objects.blocks.machines.alloyfurnace.slots.SlotAlloyFurnaceOutput;
...
public class ContainerAlloyFurnace extends Container{
	...
	public ContainerAlloyFurnace(InventoryPlayer player, TileEntityAlloyFurnace tileentity) {
		...
		//Slot 1
		this.addSlotToContainer(new Slot(tileentity, 0, 37, 12));
		//Slot 2
		this.addSlotToContainer(new Slot(tileentity, 1, 18, 35));
		//Slot 3
		this.addSlotToContainer(new Slot(tileentity, 2, 56, 35));
		//Fuel Slot
		this.addSlotToContainer(new SlotAlloyFurnaceFuel(tileentity, 3, 8, 62));
		//Output
		this.addSlotToContainer(new SlotAlloyFurnaceOutput(player.player, tileentity, 6, 116, 33));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			if (index == 4) {
				...
				if (TileEntityAlloyFurnace.isItemFuel(stack1)) this.mergeItemStack(stack1, 3, 4, false); 
